...
class GeminiAIService:
    ...
    async def generate_study_response(self, question: str, context: str = None, subject: str = None) -> str:
        ...
        try:
            ...
            prompt = f"""
You are an AI Study Assistant. Help with this {subject or 'general'} question:

Question: {question}

{f"Context: {context}" if context else ""}

Provide a clear, educational explanation suitable for learning. Be comprehensive but easy to understand.
"""
